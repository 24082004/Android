    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (sUserName.equals("")) {
                    Toast.makeText(dangky.this, "Username khong duoc de trong!", Toast.LENGTH_SHORT).show();
                } else if (sPassword.equals("")) {
                    Toast.makeText(dangky.this, "Password khong duoc de trong!", Toast.LENGTH_SHORT).show();
                } else if (sRetypePass.equals("")) {
                    Toast.makeText(dangky.this, "Password nhap lai khong duoc de trong!", Toast.LENGTH_SHORT).show();
                } else if (!sRetypePass.equals(sPassword)) {
                    Toast.makeText(dangky.this, "Password nhap lai chua dung!", Toast.LENGTH_SHORT).show();
                } else {
