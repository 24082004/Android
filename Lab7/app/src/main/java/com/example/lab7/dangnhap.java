        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!sUser.equals(chUser) && !sPass.equals(chPass)) {
                    ...
                    Toast.makeText(dangnhap.this, "Sai tên user hoặc mật khẩu vui lòng kiểm tra lại", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if(cboSave.isChecked()){
                        ...
                        Toast.makeText(dangnhap.this, "ghi thất bại", Toast.LENGTH_SHORT).show();
                    }
                    Toast.makeText(dangnhap.this, "Đăng nhập thành công", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(dangnhap.this, activity_sv.class);
                    Log.e("checkkkkkkkkkkkkk2", "onCreate: " + cboSave.isSelected());
